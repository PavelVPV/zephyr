...
__maybe_unused static int bt_tx_processor_init(void)
{
	...
	k_work_queue_start(&bt_tx_processor_workq, bt_tx_processor_stack, K_THREAD_STACK_SIZEOF(bt_tx_processor),
			   CONFIG_BT_TX_PROCESSOR_THREAD_PRIO, &cfg);

	return 0;
}

SYS_INIT(bt_tx_processor_init, POST_KERNEL, CONFIG_BT_TX_PROCESSOR_INIT_PRIORITY);
